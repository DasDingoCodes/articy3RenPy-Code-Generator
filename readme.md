...
Here are some examples to give a short overview of the Code Generator's functionality. 
Open the images to see more details.
Read the [Documentation](#documentation) for further details.
...
During the development of your game your Articy-project keeps changing. 
